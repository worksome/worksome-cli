...
func (q *Querier) AcceptBid(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	acceptBid(input: $input) { id number lastPaymentRequestDate latestContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } activeContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } draftContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } pendingContractChanges hasScheduledChanges hasSignedScheduledChange company { id name currency market avatar usedEngagementTypeSetups } job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } recruiter { id name initials avatar } supplier { __typename id name avatar } viewerIsSupplier contractType engagementType engagementTypeLabel engagementTypeSetup engagementTypeSetupLabel contractTypeShort contractTypeLabel usesClassification wcr { id } classification { id type description status title createdAt updatedAt } classificationResult classificationLabel classificationPdfUrl worker { id name firstName lastName middleName email phone avatar initials currency } conversation { id subject url createdAt } employment { id status onboardingStatus startDate endDate createdAt updatedAt } createdAt startDate endDate recruiterOwnershipStartDate recruiterFee recruiterOwnershipDays recruiterOwnershipIsExpired recruiterOwnershipDaysLeft currency rate rateType status offeredAt externalIdentifier purchaseOrderNumber compliances { actor name applicable completed completedAt type title description } recruiterManagesWorkers supplierSignatureWaived canRemoveRecruiter canRemindWorkerForBilling user { id name email avatar createdAt updatedAt } activeStatus terminationDate canTerminateContract canCancelContract hasMilestones hasEmployment hasDraftContract triggersApproval currentApprovalState { id state cancellationReason createdAt } hasPendingApproval owners { id name email avatar createdAt updatedAt } endsWithinDays tenure sourceHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } supplierHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } hasUnactedClientChanges viewerCanAcceptContract viewerCanCreatePaymentRequest fees { id feeType application currency basis } markupFee { id feeType application currency basis } }
}`
...
func (q *Querier) ApprovalApprovable(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	approvalApprovable(id: $id) { id approval { id name status trigger description createdAt updatedAt } approvalRule { id createdAt updatedAt } approvalStates { id state cancellationReason createdAt } viewerCanAction }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) ActionApprovalApprovable(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	actionApprovalApprovable(input: $input) { id approval { id name status trigger description createdAt updatedAt } approvalRule { id createdAt updatedAt } approvalStates { id state cancellationReason createdAt } viewerCanAction }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) ApprovalRule(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	approvalRule(id: $id) { id approval { id name status trigger description createdAt updatedAt } fields { id title slug description fieldType appliesTo visibility createdAt updatedAt } rules { id operator createdAt updatedAt } approvers { id createdAt updatedAt } approverCount createdAt updatedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) ApprovalRules(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	approvalRules(accounts: $accounts, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id approval { id name status trigger description createdAt updatedAt } fields { id title slug description fieldType appliesTo visibility createdAt updatedAt } rules { id operator createdAt updatedAt } approvers { id createdAt updatedAt } approverCount createdAt updatedAt } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateApprovalRule(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createApprovalRule(input: $input) { id approval { id name status trigger description createdAt updatedAt } fields { id title slug description fieldType appliesTo visibility createdAt updatedAt } rules { id operator createdAt updatedAt } approvers { id createdAt updatedAt } approverCount createdAt updatedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Approval(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	approval(id: $id) { id name version status trigger description company { id name currency market avatar usedEngagementTypeSetups } approvalRules { id createdAt updatedAt } createdAt updatedAt latestVersionId }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Approvals(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	approvals(accounts: $accounts, search: $search, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id name version status trigger description company { id name currency market avatar usedEngagementTypeSetups } approvalRules { id createdAt updatedAt } createdAt updatedAt latestVersionId } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateApproval(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createApproval(input: $input) { id name version status trigger description company { id name currency market avatar usedEngagementTypeSetups } approvalRules { id createdAt updatedAt } createdAt updatedAt latestVersionId }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateApproval(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateApproval(input: $input) { id name version status trigger description company { id name currency market avatar usedEngagementTypeSetups } approvalRules { id createdAt updatedAt } createdAt updatedAt latestVersionId }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateBatch(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createBatch(input: $input) { id name type account { __typename id name avatar } createdAt updatedAt deletedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Bid(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	bid(id: $id) { id status job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } conversation { id subject url createdAt } message { id url } worker { id name firstName lastName middleName email phone avatar initials currency } supplier { __typename id name avatar } rate rateType currency brief links files { id name title url createdAt updatedAt } fees { id feeType application currency basis } workerType }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) BlockTrustedContact(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	blockTrustedContact(input: $input) { id worker { id name firstName lastName middleName email phone avatar initials currency } company { id name currency market avatar usedEngagementTypeSetups } invitedByUser { id name email avatar createdAt updatedAt } links attachments { id name title url createdAt updatedAt } skills { id name } managedStatus status statusUpdatedAt invitedAt approvedByUser { id name email avatar createdAt updatedAt } externalIdentifier origin originChannel customFieldValues { id } requiredCustomFieldsComplete onboardingStatus onboardingDocuments { id } compliances { actor name applicable completed completedAt type title description } createdAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) InviteCandidateToOnboard(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	inviteCandidateToOnboard(input: $input) { id job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } worker { id name firstName lastName middleName email phone avatar initials currency } bid { id status rateType currency workerType } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } jobShare { id createdAt } sourcingChannel submissionType contactName contactEmail contactPhone owner { __typename id name avatar } step status statusReason statusComment isPreferred statusSetByUser { id name email avatar createdAt updatedAt } stepSetByUser { id name email avatar createdAt updatedAt } createdAt createdByUser { id name email avatar createdAt updatedAt } updatedAt updatedByUser { id name email avatar createdAt updatedAt } viewerCanUpdateStatus viewerCanUpdatePreferred sourceCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } presentedCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } stageHistory { stage createdAt } viewerCanWithdrawForwardedCandidate viewerCanWithdraw viewerCanInviteToOnboard presentedToClient sourceAgencyName }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Classifications(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	classifications(hire: $hire, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id user { id name email avatar createdAt updatedAt } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } company { id name currency market avatar usedEngagementTypeSetups } freelancer { id name firstName lastName middleName email phone avatar initials currency } type description complianceName status acceptedStatus result { outcome label title } pdfUrl overridesAnother overrideReason overrideUser { id name email avatar createdAt updatedAt } disputesAnother hasUnknownAnswers hasUpdatedAnswers hasWorkerCompletedAnswers canChange canOverride hasHireBlockingCondition currentApprovalState { id state cancellationReason createdAt } hasPendingApproval title wcrTerm hasUpdatedHire isReclassificationRequired isClassificationActionRequired endClientInputComplete createdAt updatedAt } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CompanyRecruiter(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	companyRecruiter(id: $id) { id email status token message recruiterFee recruiterOwnershipDays recruiterOwnershipDaysLeft recruiterManagesWorkers hasHires recruiter { id name initials avatar } company { id name currency market avatar usedEngagementTypeSetups } tags { id name } externalIdentifier customFieldValues { id } requiresOnboarding requiredCustomFieldsComplete onboardingDocuments { id } onboardingStatus invitedAt fees { id feeType application currency basis } compliances { actor name applicable completed completedAt type title description } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateCompanyRecruiter(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createCompanyRecruiter(input: $input) { id email status token message recruiterFee recruiterOwnershipDays recruiterOwnershipDaysLeft recruiterManagesWorkers hasHires recruiter { id name initials avatar } company { id name currency market avatar usedEngagementTypeSetups } tags { id name } externalIdentifier customFieldValues { id } requiresOnboarding requiredCustomFieldsComplete onboardingDocuments { id } onboardingStatus invitedAt fees { id feeType application currency basis } compliances { actor name applicable completed completedAt type title description } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) DeleteCompanyRecruiter(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	deleteCompanyRecruiter(input: $input) { id email status token message recruiterFee recruiterOwnershipDays recruiterOwnershipDaysLeft recruiterManagesWorkers hasHires recruiter { id name initials avatar } company { id name currency market avatar usedEngagementTypeSetups } tags { id name } externalIdentifier customFieldValues { id } requiresOnboarding requiredCustomFieldsComplete onboardingDocuments { id } onboardingStatus invitedAt fees { id feeType application currency basis } compliances { actor name applicable completed completedAt type title description } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) InviteCompanyRecruiter(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	inviteCompanyRecruiter(input: $input) { id email status token message recruiterFee recruiterOwnershipDays recruiterOwnershipDaysLeft recruiterManagesWorkers hasHires recruiter { id name initials avatar } company { id name currency market avatar usedEngagementTypeSetups } tags { id name } externalIdentifier customFieldValues { id } requiresOnboarding requiredCustomFieldsComplete onboardingDocuments { id } onboardingStatus invitedAt fees { id feeType application currency basis } compliances { actor name applicable completed completedAt type title description } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateCompanyRecruiter(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateCompanyRecruiter(input: $input) { id email status token message recruiterFee recruiterOwnershipDays recruiterOwnershipDaysLeft recruiterManagesWorkers hasHires recruiter { id name initials avatar } company { id name currency market avatar usedEngagementTypeSetups } tags { id name } externalIdentifier customFieldValues { id } requiresOnboarding requiredCustomFieldsComplete onboardingDocuments { id } onboardingStatus invitedAt fees { id feeType application currency basis } compliances { actor name applicable completed completedAt type title description } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CompanySupplier(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	companySupplier(id: $id) { id company { id name currency market avatar usedEngagementTypeSetups } supplier { __typename id name avatar } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CompanySuppliers(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	companySuppliers(accounts: $accounts, search: $search, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id company { id name currency market avatar usedEngagementTypeSetups } supplier { __typename id name avatar } } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Contract(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	contract(id: $id) { id jobName jobDescription locationPreference status startDate endDate address currency rateType rate purchaseOrderNumber companyCvr pdfUrl paymentTermMethod paymentTerm termsAccepted termsAcceptedAt workerAcceptedAt effectiveAt workerSignature job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } worker { id name firstName lastName middleName email phone avatar initials currency } company { id name currency market avatar usedEngagementTypeSetups } companyContact { id name email avatar createdAt updatedAt } businessEntity { id type name companyNumberValidationStatus } companyName files { id name title url createdAt updatedAt } contractDocuments { id createdAt updatedAt } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Conversation(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	conversation(id: $id) { id subject job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } latestMessage { id url } url viewerCanAccess createdAt isClosed isUnread closedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Conversations(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	conversations(accounts: $accounts, isOpen: $isOpen, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id subject job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } latestMessage { id url } url viewerCanAccess createdAt isClosed isUnread closedAt } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateCustomField(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createCustomField(input: $input) { id user { id name email avatar createdAt updatedAt } account { __typename id name avatar } title slug description fieldType appliesTo customFieldOptions { id } settings { validation } visibility customFieldValues { id } isUsedInFieldValues rule { id operator createdAt updatedAt } approval viewerCanUpdate viewerOwnsField apiOnly workerInputAllowed recruiterInputAllowed showOnInvoice sharedWithClients sharedWithStaffingAgencies createdAt updatedAt deletedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) DeleteCustomField(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	deleteCustomField(input: $input) { id user { id name email avatar createdAt updatedAt } account { __typename id name avatar } title slug description fieldType appliesTo customFieldOptions { id } settings { validation } visibility customFieldValues { id } isUsedInFieldValues rule { id operator createdAt updatedAt } approval viewerCanUpdate viewerOwnsField apiOnly workerInputAllowed recruiterInputAllowed showOnInvoice sharedWithClients sharedWithStaffingAgencies createdAt updatedAt deletedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateCustomField(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateCustomField(input: $input) { id user { id name email avatar createdAt updatedAt } account { __typename id name avatar } title slug description fieldType appliesTo customFieldOptions { id } settings { validation } visibility customFieldValues { id } isUsedInFieldValues rule { id operator createdAt updatedAt } approval viewerCanUpdate viewerOwnsField apiOnly workerInputAllowed recruiterInputAllowed showOnInvoice sharedWithClients sharedWithStaffingAgencies createdAt updatedAt deletedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) OnboardEmployment(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	onboardEmployment(input: $input) { id worker { id name firstName lastName middleName email phone avatar initials currency } employerOfRecord { __typename id name avatar } hiringManagers { id name email avatar createdAt updatedAt } status onboardingStatus startDate endDate firstPayrolledAt previouslyHired createdAt updatedAt isOnboarded onboardedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) MarkFilesAsUploaded(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	markFilesAsUploaded(input: $input) { id name title size humanReadableSize mimeType owner { __typename id name avatar } url createdAt updatedAt tags { id name } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) ForwardCandidate(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	forwardCandidate(input: $input) { id job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } worker { id name firstName lastName middleName email phone avatar initials currency } bid { id status rateType currency workerType } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } jobShare { id createdAt } sourcingChannel submissionType contactName contactEmail contactPhone owner { __typename id name avatar } step status statusReason statusComment isPreferred statusSetByUser { id name email avatar createdAt updatedAt } stepSetByUser { id name email avatar createdAt updatedAt } createdAt createdByUser { id name email avatar createdAt updatedAt } updatedAt updatedByUser { id name email avatar createdAt updatedAt } viewerCanUpdateStatus viewerCanUpdatePreferred sourceCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } presentedCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } stageHistory { stage createdAt } viewerCanWithdrawForwardedCandidate viewerCanWithdraw viewerCanInviteToOnboard presentedToClient sourceAgencyName }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Hire(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	hire(id: $id) { id number lastPaymentRequestDate latestContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } activeContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } draftContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } pendingContractChanges hasScheduledChanges hasSignedScheduledChange company { id name currency market avatar usedEngagementTypeSetups } job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } recruiter { id name initials avatar } supplier { __typename id name avatar } viewerIsSupplier contractType engagementType engagementTypeLabel engagementTypeSetup engagementTypeSetupLabel contractTypeShort contractTypeLabel usesClassification wcr { id } classification { id type description status title createdAt updatedAt } classificationResult classificationLabel classificationPdfUrl worker { id name firstName lastName middleName email phone avatar initials currency } conversation { id subject url createdAt } employment { id status onboardingStatus startDate endDate createdAt updatedAt } createdAt startDate endDate recruiterOwnershipStartDate recruiterFee recruiterOwnershipDays recruiterOwnershipIsExpired recruiterOwnershipDaysLeft currency rate rateType status offeredAt externalIdentifier purchaseOrderNumber compliances { actor name applicable completed completedAt type title description } recruiterManagesWorkers supplierSignatureWaived canRemoveRecruiter canRemindWorkerForBilling user { id name email avatar createdAt updatedAt } activeStatus terminationDate canTerminateContract canCancelContract hasMilestones hasEmployment hasDraftContract triggersApproval currentApprovalState { id state cancellationReason createdAt } hasPendingApproval owners { id name email avatar createdAt updatedAt } endsWithinDays tenure sourceHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } supplierHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } hasUnactedClientChanges viewerCanAcceptContract viewerCanCreatePaymentRequest fees { id feeType application currency basis } markupFee { id feeType application currency basis } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) AttributeRecruiterToHire(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	attributeRecruiterToHire(input: $input) { id number lastPaymentRequestDate latestContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } activeContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } draftContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } pendingContractChanges hasScheduledChanges hasSignedScheduledChange company { id name currency market avatar usedEngagementTypeSetups } job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } recruiter { id name initials avatar } supplier { __typename id name avatar } viewerIsSupplier contractType engagementType engagementTypeLabel engagementTypeSetup engagementTypeSetupLabel contractTypeShort contractTypeLabel usesClassification wcr { id } classification { id type description status title createdAt updatedAt } classificationResult classificationLabel classificationPdfUrl worker { id name firstName lastName middleName email phone avatar initials currency } conversation { id subject url createdAt } employment { id status onboardingStatus startDate endDate createdAt updatedAt } createdAt startDate endDate recruiterOwnershipStartDate recruiterFee recruiterOwnershipDays recruiterOwnershipIsExpired recruiterOwnershipDaysLeft currency rate rateType status offeredAt externalIdentifier purchaseOrderNumber compliances { actor name applicable completed completedAt type title description } recruiterManagesWorkers supplierSignatureWaived canRemoveRecruiter canRemindWorkerForBilling user { id name email avatar createdAt updatedAt } activeStatus terminationDate canTerminateContract canCancelContract hasMilestones hasEmployment hasDraftContract triggersApproval currentApprovalState { id state cancellationReason createdAt } hasPendingApproval owners { id name email avatar createdAt updatedAt } endsWithinDays tenure sourceHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } supplierHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } hasUnactedClientChanges viewerCanAcceptContract viewerCanCreatePaymentRequest fees { id feeType application currency basis } markupFee { id feeType application currency basis } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) AttributeSupplierToHire(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	attributeSupplierToHire(input: $input) { id number lastPaymentRequestDate latestContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } activeContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } draftContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } pendingContractChanges hasScheduledChanges hasSignedScheduledChange company { id name currency market avatar usedEngagementTypeSetups } job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } recruiter { id name initials avatar } supplier { __typename id name avatar } viewerIsSupplier contractType engagementType engagementTypeLabel engagementTypeSetup engagementTypeSetupLabel contractTypeShort contractTypeLabel usesClassification wcr { id } classification { id type description status title createdAt updatedAt } classificationResult classificationLabel classificationPdfUrl worker { id name firstName lastName middleName email phone avatar initials currency } conversation { id subject url createdAt } employment { id status onboardingStatus startDate endDate createdAt updatedAt } createdAt startDate endDate recruiterOwnershipStartDate recruiterFee recruiterOwnershipDays recruiterOwnershipIsExpired recruiterOwnershipDaysLeft currency rate rateType status offeredAt externalIdentifier purchaseOrderNumber compliances { actor name applicable completed completedAt type title description } recruiterManagesWorkers supplierSignatureWaived canRemoveRecruiter canRemindWorkerForBilling user { id name email avatar createdAt updatedAt } activeStatus terminationDate canTerminateContract canCancelContract hasMilestones hasEmployment hasDraftContract triggersApproval currentApprovalState { id state cancellationReason createdAt } hasPendingApproval owners { id name email avatar createdAt updatedAt } endsWithinDays tenure sourceHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } supplierHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } hasUnactedClientChanges viewerCanAcceptContract viewerCanCreatePaymentRequest fees { id feeType application currency basis } markupFee { id feeType application currency basis } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CancelHire(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	cancelHire(input: $input) { id number lastPaymentRequestDate latestContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } activeContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } draftContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } pendingContractChanges hasScheduledChanges hasSignedScheduledChange company { id name currency market avatar usedEngagementTypeSetups } job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } recruiter { id name initials avatar } supplier { __typename id name avatar } viewerIsSupplier contractType engagementType engagementTypeLabel engagementTypeSetup engagementTypeSetupLabel contractTypeShort contractTypeLabel usesClassification wcr { id } classification { id type description status title createdAt updatedAt } classificationResult classificationLabel classificationPdfUrl worker { id name firstName lastName middleName email phone avatar initials currency } conversation { id subject url createdAt } employment { id status onboardingStatus startDate endDate createdAt updatedAt } createdAt startDate endDate recruiterOwnershipStartDate recruiterFee recruiterOwnershipDays recruiterOwnershipIsExpired recruiterOwnershipDaysLeft currency rate rateType status offeredAt externalIdentifier purchaseOrderNumber compliances { actor name applicable completed completedAt type title description } recruiterManagesWorkers supplierSignatureWaived canRemoveRecruiter canRemindWorkerForBilling user { id name email avatar createdAt updatedAt } activeStatus terminationDate canTerminateContract canCancelContract hasMilestones hasEmployment hasDraftContract triggersApproval currentApprovalState { id state cancellationReason createdAt } hasPendingApproval owners { id name email avatar createdAt updatedAt } endsWithinDays tenure sourceHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } supplierHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } hasUnactedClientChanges viewerCanAcceptContract viewerCanCreatePaymentRequest fees { id feeType application currency basis } markupFee { id feeType application currency basis } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateDraftHire(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createDraftHire(input: $input) { id number lastPaymentRequestDate latestContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } activeContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } draftContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } pendingContractChanges hasScheduledChanges hasSignedScheduledChange company { id name currency market avatar usedEngagementTypeSetups } job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } recruiter { id name initials avatar } supplier { __typename id name avatar } viewerIsSupplier contractType engagementType engagementTypeLabel engagementTypeSetup engagementTypeSetupLabel contractTypeShort contractTypeLabel usesClassification wcr { id } classification { id type description status title createdAt updatedAt } classificationResult classificationLabel classificationPdfUrl worker { id name firstName lastName middleName email phone avatar initials currency } conversation { id subject url createdAt } employment { id status onboardingStatus startDate endDate createdAt updatedAt } createdAt startDate endDate recruiterOwnershipStartDate recruiterFee recruiterOwnershipDays recruiterOwnershipIsExpired recruiterOwnershipDaysLeft currency rate rateType status offeredAt externalIdentifier purchaseOrderNumber compliances { actor name applicable completed completedAt type title description } recruiterManagesWorkers supplierSignatureWaived canRemoveRecruiter canRemindWorkerForBilling user { id name email avatar createdAt updatedAt } activeStatus terminationDate canTerminateContract canCancelContract hasMilestones hasEmployment hasDraftContract triggersApproval currentApprovalState { id state cancellationReason createdAt } hasPendingApproval owners { id name email avatar createdAt updatedAt } endsWithinDays tenure sourceHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } supplierHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } hasUnactedClientChanges viewerCanAcceptContract viewerCanCreatePaymentRequest fees { id feeType application currency basis } markupFee { id feeType application currency basis } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) RejectHire(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	rejectHire(input: $input) { id number lastPaymentRequestDate latestContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } activeContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } draftContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } pendingContractChanges hasScheduledChanges hasSignedScheduledChange company { id name currency market avatar usedEngagementTypeSetups } job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } recruiter { id name initials avatar } supplier { __typename id name avatar } viewerIsSupplier contractType engagementType engagementTypeLabel engagementTypeSetup engagementTypeSetupLabel contractTypeShort contractTypeLabel usesClassification wcr { id } classification { id type description status title createdAt updatedAt } classificationResult classificationLabel classificationPdfUrl worker { id name firstName lastName middleName email phone avatar initials currency } conversation { id subject url createdAt } employment { id status onboardingStatus startDate endDate createdAt updatedAt } createdAt startDate endDate recruiterOwnershipStartDate recruiterFee recruiterOwnershipDays recruiterOwnershipIsExpired recruiterOwnershipDaysLeft currency rate rateType status offeredAt externalIdentifier purchaseOrderNumber compliances { actor name applicable completed completedAt type title description } recruiterManagesWorkers supplierSignatureWaived canRemoveRecruiter canRemindWorkerForBilling user { id name email avatar createdAt updatedAt } activeStatus terminationDate canTerminateContract canCancelContract hasMilestones hasEmployment hasDraftContract triggersApproval currentApprovalState { id state cancellationReason createdAt } hasPendingApproval owners { id name email avatar createdAt updatedAt } endsWithinDays tenure sourceHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } supplierHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } hasUnactedClientChanges viewerCanAcceptContract viewerCanCreatePaymentRequest fees { id feeType application currency basis } markupFee { id feeType application currency basis } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) RemoveRecruiterFromHire(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	removeRecruiterFromHire(input: $input) { id number lastPaymentRequestDate latestContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } activeContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } draftContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } pendingContractChanges hasScheduledChanges hasSignedScheduledChange company { id name currency market avatar usedEngagementTypeSetups } job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } recruiter { id name initials avatar } supplier { __typename id name avatar } viewerIsSupplier contractType engagementType engagementTypeLabel engagementTypeSetup engagementTypeSetupLabel contractTypeShort contractTypeLabel usesClassification wcr { id } classification { id type description status title createdAt updatedAt } classificationResult classificationLabel classificationPdfUrl worker { id name firstName lastName middleName email phone avatar initials currency } conversation { id subject url createdAt } employment { id status onboardingStatus startDate endDate createdAt updatedAt } createdAt startDate endDate recruiterOwnershipStartDate recruiterFee recruiterOwnershipDays recruiterOwnershipIsExpired recruiterOwnershipDaysLeft currency rate rateType status offeredAt externalIdentifier purchaseOrderNumber compliances { actor name applicable completed completedAt type title description } recruiterManagesWorkers supplierSignatureWaived canRemoveRecruiter canRemindWorkerForBilling user { id name email avatar createdAt updatedAt } activeStatus terminationDate canTerminateContract canCancelContract hasMilestones hasEmployment hasDraftContract triggersApproval currentApprovalState { id state cancellationReason createdAt } hasPendingApproval owners { id name email avatar createdAt updatedAt } endsWithinDays tenure sourceHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } supplierHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } hasUnactedClientChanges viewerCanAcceptContract viewerCanCreatePaymentRequest fees { id feeType application currency basis } markupFee { id feeType application currency basis } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) ShareHire(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	shareHire(input: $input) { id number lastPaymentRequestDate latestContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } activeContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } draftContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } pendingContractChanges hasScheduledChanges hasSignedScheduledChange company { id name currency market avatar usedEngagementTypeSetups } job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } recruiter { id name initials avatar } supplier { __typename id name avatar } viewerIsSupplier contractType engagementType engagementTypeLabel engagementTypeSetup engagementTypeSetupLabel contractTypeShort contractTypeLabel usesClassification wcr { id } classification { id type description status title createdAt updatedAt } classificationResult classificationLabel classificationPdfUrl worker { id name firstName lastName middleName email phone avatar initials currency } conversation { id subject url createdAt } employment { id status onboardingStatus startDate endDate createdAt updatedAt } createdAt startDate endDate recruiterOwnershipStartDate recruiterFee recruiterOwnershipDays recruiterOwnershipIsExpired recruiterOwnershipDaysLeft currency rate rateType status offeredAt externalIdentifier purchaseOrderNumber compliances { actor name applicable completed completedAt type title description } recruiterManagesWorkers supplierSignatureWaived canRemoveRecruiter canRemindWorkerForBilling user { id name email avatar createdAt updatedAt } activeStatus terminationDate canTerminateContract canCancelContract hasMilestones hasEmployment hasDraftContract triggersApproval currentApprovalState { id state cancellationReason createdAt } hasPendingApproval owners { id name email avatar createdAt updatedAt } endsWithinDays tenure sourceHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } supplierHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } hasUnactedClientChanges viewerCanAcceptContract viewerCanCreatePaymentRequest fees { id feeType application currency basis } markupFee { id feeType application currency basis } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) TerminateHire(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	terminateHire(input: $input) { id number lastPaymentRequestDate latestContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } activeContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } draftContract { id locationPreference status startDate endDate currency rateType paymentTermMethod } pendingContractChanges hasScheduledChanges hasSignedScheduledChange company { id name currency market avatar usedEngagementTypeSetups } job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } recruiter { id name initials avatar } supplier { __typename id name avatar } viewerIsSupplier contractType engagementType engagementTypeLabel engagementTypeSetup engagementTypeSetupLabel contractTypeShort contractTypeLabel usesClassification wcr { id } classification { id type description status title createdAt updatedAt } classificationResult classificationLabel classificationPdfUrl worker { id name firstName lastName middleName email phone avatar initials currency } conversation { id subject url createdAt } employment { id status onboardingStatus startDate endDate createdAt updatedAt } createdAt startDate endDate recruiterOwnershipStartDate recruiterFee recruiterOwnershipDays recruiterOwnershipIsExpired recruiterOwnershipDaysLeft currency rate rateType status offeredAt externalIdentifier purchaseOrderNumber compliances { actor name applicable completed completedAt type title description } recruiterManagesWorkers supplierSignatureWaived canRemoveRecruiter canRemindWorkerForBilling user { id name email avatar createdAt updatedAt } activeStatus terminationDate canTerminateContract canCancelContract hasMilestones hasEmployment hasDraftContract triggersApproval currentApprovalState { id state cancellationReason createdAt } hasPendingApproval owners { id name email avatar createdAt updatedAt } endsWithinDays tenure sourceHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } supplierHire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } hasUnactedClientChanges viewerCanAcceptContract viewerCanCreatePaymentRequest fees { id feeType application currency basis } markupFee { id feeType application currency basis } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) IncomingJobs(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	incomingJobs(search: $search, orderBy: $orderBy, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id number name contactName contactEmail contactPhone skills { id name } description market status address currency rateType rate minimumRate maximumRate paymentScheme companyFee workerFee association project { id name description currency endDate } internalBudget spent expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate attachments { id name title url createdAt updatedAt } isExtensionAvailable evaluationPeriod sourcingEndDate sourcingDeadlineChoice sourcingEndDateLocal languages { name experience } industries { id name } requiredWorkers owners { id name email avatar createdAt updatedAt } customFieldValues { id } visibility approved available paused completed published draft removed removedCause publishedAt company { id name currency market avatar usedEngagementTypeSetups } region url viewerCanDelete viewerCanEdit viewerCanShare viewerCanCreateJobCandidate viewerCanCreateHire createdAt updatedAt isForContacts isForRecruiters isForMarketplace externalIdentifier canBePublished isJobPost isBrief isAvailable sourceJob { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } supplierJob { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) InvoiceRow(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	invoiceRow(id: $id) { id paymentRequest { id number startDate endDate currency rateType completedAt workerStatus workerPayoutStatus status } worker { id name firstName lastName middleName email phone avatar initials currency } customText }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Invoice(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	invoice(number: $number) { id number pdfUrl currency grossAmount grossOpenAmount taxAmount netAmount markedPaidAt dueDate company { id name currency market avatar usedEngagementTypeSetups } payerBusinessEntity { id type name companyNumberValidationStatus } payeeBusinessEntity { id type name companyNumberValidationStatus } payerDisplayName payeeDisplayName date isBatched transactionType isFullyCredited isOverDue creditNotes { id number currency transactionType } originalInvoice { id number currency transactionType } externalIdentifier }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateJobCandidatePreferred(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateJobCandidatePreferred(input: $input) { id job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } worker { id name firstName lastName middleName email phone avatar initials currency } bid { id status rateType currency workerType } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } jobShare { id createdAt } sourcingChannel submissionType contactName contactEmail contactPhone owner { __typename id name avatar } step status statusReason statusComment isPreferred statusSetByUser { id name email avatar createdAt updatedAt } stepSetByUser { id name email avatar createdAt updatedAt } createdAt createdByUser { id name email avatar createdAt updatedAt } updatedAt updatedByUser { id name email avatar createdAt updatedAt } viewerCanUpdateStatus viewerCanUpdatePreferred sourceCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } presentedCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } stageHistory { stage createdAt } viewerCanWithdrawForwardedCandidate viewerCanWithdraw viewerCanInviteToOnboard presentedToClient sourceAgencyName }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateJobCandidateStatus(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateJobCandidateStatus(input: $input) { id job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } worker { id name firstName lastName middleName email phone avatar initials currency } bid { id status rateType currency workerType } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } jobShare { id createdAt } sourcingChannel submissionType contactName contactEmail contactPhone owner { __typename id name avatar } step status statusReason statusComment isPreferred statusSetByUser { id name email avatar createdAt updatedAt } stepSetByUser { id name email avatar createdAt updatedAt } createdAt createdByUser { id name email avatar createdAt updatedAt } updatedAt updatedByUser { id name email avatar createdAt updatedAt } viewerCanUpdateStatus viewerCanUpdatePreferred sourceCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } presentedCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } stageHistory { stage createdAt } viewerCanWithdrawForwardedCandidate viewerCanWithdraw viewerCanInviteToOnboard presentedToClient sourceAgencyName }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateJobCandidateStep(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateJobCandidateStep(input: $input) { id job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } worker { id name firstName lastName middleName email phone avatar initials currency } bid { id status rateType currency workerType } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } jobShare { id createdAt } sourcingChannel submissionType contactName contactEmail contactPhone owner { __typename id name avatar } step status statusReason statusComment isPreferred statusSetByUser { id name email avatar createdAt updatedAt } stepSetByUser { id name email avatar createdAt updatedAt } createdAt createdByUser { id name email avatar createdAt updatedAt } updatedAt updatedByUser { id name email avatar createdAt updatedAt } viewerCanUpdateStatus viewerCanUpdatePreferred sourceCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } presentedCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } stageHistory { stage createdAt } viewerCanWithdrawForwardedCandidate viewerCanWithdraw viewerCanInviteToOnboard presentedToClient sourceAgencyName }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) JobCandidate(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	jobCandidate(id: $id) { id job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } worker { id name firstName lastName middleName email phone avatar initials currency } bid { id status rateType currency workerType } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } jobShare { id createdAt } sourcingChannel submissionType contactName contactEmail contactPhone owner { __typename id name avatar } step status statusReason statusComment isPreferred statusSetByUser { id name email avatar createdAt updatedAt } stepSetByUser { id name email avatar createdAt updatedAt } createdAt createdByUser { id name email avatar createdAt updatedAt } updatedAt updatedByUser { id name email avatar createdAt updatedAt } viewerCanUpdateStatus viewerCanUpdatePreferred sourceCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } presentedCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } stageHistory { stage createdAt } viewerCanWithdrawForwardedCandidate viewerCanWithdraw viewerCanInviteToOnboard presentedToClient sourceAgencyName }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateJobCandidate(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createJobCandidate(input: $input) { id job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } worker { id name firstName lastName middleName email phone avatar initials currency } bid { id status rateType currency workerType } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } jobShare { id createdAt } sourcingChannel submissionType contactName contactEmail contactPhone owner { __typename id name avatar } step status statusReason statusComment isPreferred statusSetByUser { id name email avatar createdAt updatedAt } stepSetByUser { id name email avatar createdAt updatedAt } createdAt createdByUser { id name email avatar createdAt updatedAt } updatedAt updatedByUser { id name email avatar createdAt updatedAt } viewerCanUpdateStatus viewerCanUpdatePreferred sourceCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } presentedCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } stageHistory { stage createdAt } viewerCanWithdrawForwardedCandidate viewerCanWithdraw viewerCanInviteToOnboard presentedToClient sourceAgencyName }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) JobShares(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	jobShares(jobs: $jobs, accountTypes: $accountTypes, isActive: $isActive, companies: $companies, orderBy: $orderBy, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id isActive createdAt job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateJobShare(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createJobShare(input: $input) { id isActive createdAt job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) RemoveJobShare(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	removeJobShare(input: $input) { id isActive createdAt job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Milestone(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	milestone(id: $id) { id name purchaseOrderNumber status details { id } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Milestones(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	milestones(accounts: $accounts, hires: $hires, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id name purchaseOrderNumber status details { id } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateMilestones(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createMilestones(input: $input) { id name purchaseOrderNumber status details { id } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) DeleteMilestones(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	deleteMilestones(input: $input) { id name purchaseOrderNumber status details { id } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateMilestones(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateMilestones(input: $input) { id name purchaseOrderNumber status details { id } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Partner(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	partner(id: $id) { id name slug currency market avatar primaryBusinessEntity { id type name companyNumberValidationStatus } primaryProfile { id url } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) ShareCandidatesWithPartner(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	shareCandidatesWithPartner(input: $input) { id job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } worker { id name firstName lastName middleName email phone avatar initials currency } bid { id status rateType currency workerType } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } jobShare { id createdAt } sourcingChannel submissionType contactName contactEmail contactPhone owner { __typename id name avatar } step status statusReason statusComment isPreferred statusSetByUser { id name email avatar createdAt updatedAt } stepSetByUser { id name email avatar createdAt updatedAt } createdAt createdByUser { id name email avatar createdAt updatedAt } updatedAt updatedByUser { id name email avatar createdAt updatedAt } viewerCanUpdateStatus viewerCanUpdatePreferred sourceCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } presentedCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } stageHistory { stage createdAt } viewerCanWithdrawForwardedCandidate viewerCanWithdraw viewerCanInviteToOnboard presentedToClient sourceAgencyName }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) PaymentRequest(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	paymentRequest(id: $id) { id worker { id name firstName lastName middleName email phone avatar initials currency } recruiter { id name initials avatar } company { id name currency market avatar usedEngagementTypeSetups } number purchaseOrderNumber startDate endDate currency rate rateType rateTypeName ratetypeNameSlash rateQuantity expensesAmount invoice { id number currency transactionType } recruiterFeeAmount employmentCostAmount billedAmount billedAmountWithExpenses date manuallyApprovedAt approvedBy { id name email avatar createdAt updatedAt } autoApprovedAt rejectedAt prepaidAt issuedAt cancelledAt paidAt payrolledAt dueAt completedAt processedAt hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } message { id url } comments workerStatus workerPayoutStatus status timesheet { id startDate endDate createdAt } legacyTimesheet { format } externalIdentifier sourcePaymentRequest { id number startDate endDate currency rateType completedAt workerStatus workerPayoutStatus status } clientPaymentRequest { id number startDate endDate currency rateType completedAt workerStatus workerPayoutStatus status } fees { id feeType application currency basis } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Project(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	project(id: $id) { id name description currency creator { id name email avatar createdAt updatedAt } company { id name currency market avatar usedEngagementTypeSetups } internalBudget allocatedBudget spent endDate owners { id name email avatar createdAt updatedAt } externalIdentifier }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Projects(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	projects(accounts: $accounts, search: $search, status: $status, owners: $owners, externalIdentifiers: $externalIdentifiers, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id name description currency creator { id name email avatar createdAt updatedAt } company { id name currency market avatar usedEngagementTypeSetups } internalBudget allocatedBudget spent endDate owners { id name email avatar createdAt updatedAt } externalIdentifier } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) AttachJobsToProject(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	attachJobsToProject(input: $input) { id name description currency creator { id name email avatar createdAt updatedAt } company { id name currency market avatar usedEngagementTypeSetups } internalBudget allocatedBudget spent endDate owners { id name email avatar createdAt updatedAt } externalIdentifier }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateProject(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createProject(input: $input) { id name description currency creator { id name email avatar createdAt updatedAt } company { id name currency market avatar usedEngagementTypeSetups } internalBudget allocatedBudget spent endDate owners { id name email avatar createdAt updatedAt } externalIdentifier }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) DeleteProject(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	deleteProject(input: $input) { id name description currency creator { id name email avatar createdAt updatedAt } company { id name currency market avatar usedEngagementTypeSetups } internalBudget allocatedBudget spent endDate owners { id name email avatar createdAt updatedAt } externalIdentifier }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) DetachJobFromProject(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	detachJobFromProject(input: $input) { id name description currency creator { id name email avatar createdAt updatedAt } company { id name currency market avatar usedEngagementTypeSetups } internalBudget allocatedBudget spent endDate owners { id name email avatar createdAt updatedAt } externalIdentifier }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) EndProject(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	endProject(input: $input) { id name description currency creator { id name email avatar createdAt updatedAt } company { id name currency market avatar usedEngagementTypeSetups } internalBudget allocatedBudget spent endDate owners { id name email avatar createdAt updatedAt } externalIdentifier }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) OpenProject(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	openProject(input: $input) { id name description currency creator { id name email avatar createdAt updatedAt } company { id name currency market avatar usedEngagementTypeSetups } internalBudget allocatedBudget spent endDate owners { id name email avatar createdAt updatedAt } externalIdentifier }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateProject(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateProject(input: $input) { id name description currency creator { id name email avatar createdAt updatedAt } company { id name currency market avatar usedEngagementTypeSetups } internalBudget allocatedBudget spent endDate owners { id name email avatar createdAt updatedAt } externalIdentifier }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Recruiter(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	recruiter(id: $id) { id name market { code name } initials avatar owner { id name email avatar createdAt updatedAt } clients { id email status onboardingStatus } candidates { id email status relationshipLabel } insurances { type title updatedAt } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Recruiters(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	recruiters(search: $search, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id name market { code name } initials avatar owner { id name email avatar createdAt updatedAt } clients { id email status onboardingStatus } candidates { id email status relationshipLabel } insurances { type title updatedAt } } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateSupplierCandidate(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createSupplierCandidate(input: $input) { id supplier { __typename id name avatar } worker { id name firstName lastName middleName email phone avatar initials currency } email status token rate jobTitle links tags { id name } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) DeleteSupplierCandidate(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	deleteSupplierCandidate(input: $input) { id supplier { __typename id name avatar } worker { id name firstName lastName middleName email phone avatar initials currency } email status token rate jobTitle links tags { id name } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateSupplierCandidate(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateSupplierCandidate(input: $input) { id supplier { __typename id name avatar } worker { id name firstName lastName middleName email phone avatar initials currency } email status token rate jobTitle links tags { id name } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Timesheet(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	timesheet(id: $id) { id worker { id name firstName lastName middleName email phone avatar initials currency } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } startDate endDate createdAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Timesheets(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	timesheets(accounts: $accounts, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id worker { id name firstName lastName middleName email phone avatar initials currency } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } startDate endDate createdAt } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateCustomTimesheet(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createCustomTimesheet(input: $input) { providedRegistrations successfulRegistrations rejectedRegistrations { reason } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateTimesheet(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createTimesheet(input: $input) { id worker { id name firstName lastName middleName email phone avatar initials currency } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } startDate endDate createdAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) DeleteTimesheet(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	deleteTimesheet(input: $input) { id worker { id name firstName lastName middleName email phone avatar initials currency } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } startDate endDate createdAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateTimesheet(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateTimesheet(input: $input) { id worker { id name firstName lastName middleName email phone avatar initials currency } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } startDate endDate createdAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UserGroup(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	userGroup(id: $id) { id name description company { id name currency market avatar usedEngagementTypeSetups } status }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UserGroups(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	userGroups(accounts: $accounts, search: $search, users: $users, status: $status, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id name description company { id name currency market avatar usedEngagementTypeSetups } status } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) AttachUsersToUserGroup(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	attachUsersToUserGroup(input: $input) { id name description company { id name currency market avatar usedEngagementTypeSetups } status }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateUserGroup(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createUserGroup(input: $input) { id name description company { id name currency market avatar usedEngagementTypeSetups } status }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) DeleteUserGroup(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	deleteUserGroup(input: $input) { id name description company { id name currency market avatar usedEngagementTypeSetups } status }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) DetachUsersFromUserGroup(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	detachUsersFromUserGroup(input: $input) { id name description company { id name currency market avatar usedEngagementTypeSetups } status }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateUserGroup(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateUserGroup(input: $input) { id name description company { id name currency market avatar usedEngagementTypeSetups } status }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) WithdrawJobCandidate(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	withdrawJobCandidate(input: $input) { id job { id number name description market status currency rateType paymentScheme association expectedExperienceLevel locationPreference startDate startDateTimeframe endDateTimeframe endDate evaluationPeriod sourcingDeadlineChoice visibility completed url createdAt updatedAt } worker { id name firstName lastName middleName email phone avatar initials currency } bid { id status rateType currency workerType } hire { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } jobShare { id createdAt } sourcingChannel submissionType contactName contactEmail contactPhone owner { __typename id name avatar } step status statusReason statusComment isPreferred statusSetByUser { id name email avatar createdAt updatedAt } stepSetByUser { id name email avatar createdAt updatedAt } createdAt createdByUser { id name email avatar createdAt updatedAt } updatedAt updatedByUser { id name email avatar createdAt updatedAt } viewerCanUpdateStatus viewerCanUpdatePreferred sourceCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } presentedCandidate { id sourcingChannel submissionType step status statusReason createdAt updatedAt } stageHistory { stage createdAt } viewerCanWithdrawForwardedCandidate viewerCanWithdraw viewerCanInviteToOnboard presentedToClient sourceAgencyName }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Worker(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	worker(id: $id) { id name firstName lastName middleName email phone avatar market { code name } skills { id name } profile { id url } jobTitle initials viewerCanEdit currency dayRate rtwVerifiedAt rtwExpiresAt hiresWithAttribution { id number contractType engagementType engagementTypeSetup classificationResult createdAt startDate endDate currency status activeStatus } primaryBusinessEntity { id type name companyNumberValidationStatus } clients { id status origin originChannel onboardingStatus } insurances { type title updatedAt } identification { documentType } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
