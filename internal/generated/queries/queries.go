...
func (q *Querier) Batch(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	batch(id: $id) { id name type account { id name avatar } createdAt updatedAt deletedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Batches(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	batches(accounts: $accounts, types: $types, containsItemsWithStatus: $containsItemsWithStatus, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id name type account { id name avatar } createdAt updatedAt deletedAt } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateBatch(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createBatch(input: $input) { id name type account { id name avatar } createdAt updatedAt deletedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CompanySupplier(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	companySupplier(id: $id) { id company { id name currency market avatar } supplier { id name avatar } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CompanySuppliers(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	companySuppliers(accounts: $accounts, search: $search, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id company { id name currency market avatar } supplier { id name avatar } } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateCustomField(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createCustomField(input: $input) { id user { id name email avatar createdAt updatedAt } account { id name avatar } title slug description fieldType appliesTo customFieldOptions { id } visibility customFieldValues { id } isUsedInFieldValues rule { id createdAt updatedAt } approval viewerCanUpdate viewerOwnsField apiOnly workerInputAllowed recruiterInputAllowed showOnInvoice sharedWithClients sharedWithStaffingAgencies createdAt updatedAt deletedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) DeleteCustomField(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	deleteCustomField(input: $input) { id user { id name email avatar createdAt updatedAt } account { id name avatar } title slug description fieldType appliesTo customFieldOptions { id } visibility customFieldValues { id } isUsedInFieldValues rule { id createdAt updatedAt } approval viewerCanUpdate viewerOwnsField apiOnly workerInputAllowed recruiterInputAllowed showOnInvoice sharedWithClients sharedWithStaffingAgencies createdAt updatedAt deletedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateCustomField(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateCustomField(input: $input) { id user { id name email avatar createdAt updatedAt } account { id name avatar } title slug description fieldType appliesTo customFieldOptions { id } visibility customFieldValues { id } isUsedInFieldValues rule { id createdAt updatedAt } approval viewerCanUpdate viewerOwnsField apiOnly workerInputAllowed recruiterInputAllowed showOnInvoice sharedWithClients sharedWithStaffingAgencies createdAt updatedAt deletedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) ApproveEmploymentChanges(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	approveEmploymentChanges(input: $input) { id worker { id name firstName lastName middleName email phone avatar initials currency } employerOfRecord { id name avatar } hiringManagers { id name email avatar createdAt updatedAt } status onboardingStatus startDate endDate firstPayrolledAt previouslyHired createdAt updatedAt isOnboarded onboardedAt }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) File(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	file(id: $id) { id name title size humanReadableSize mimeType owner { id name avatar } url createdAt updatedAt tags { id name } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) Files(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	files(accounts: $accounts, mimeTypes: $mimeTypes, first: $first, page: $page) { paginatorInfo { count currentPage hasMorePages lastPage perPage total } data { id name title size humanReadableSize mimeType owner { id name avatar } url createdAt updatedAt tags { id name } } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) MarkFilesAsUploaded(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	markFilesAsUploaded(input: $input) { id name title size humanReadableSize mimeType owner { id name avatar } url createdAt updatedAt tags { id name } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateNote(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createNote(input: $input) { id title body author { id name email avatar createdAt updatedAt } account { id name avatar } createdAt updatedAt viewerCanUpdate viewerCanDelete }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) DeleteNote(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	deleteNote(input: $input) { id title body author { id name email avatar createdAt updatedAt } account { id name avatar } createdAt updatedAt viewerCanUpdate viewerCanDelete }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateNote(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateNote(input: $input) { id title body author { id name email avatar createdAt updatedAt } account { id name avatar } createdAt updatedAt viewerCanUpdate viewerCanDelete }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) SupplierCandidate(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	supplierCandidate(id: $id) { id supplier { id name avatar } worker { id name firstName lastName middleName email phone avatar initials currency } email status token rate jobTitle links tags { id name } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) CreateSupplierCandidate(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	createSupplierCandidate(input: $input) { id supplier { id name avatar } worker { id name firstName lastName middleName email phone avatar initials currency } email status token rate jobTitle links tags { id name } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) DeleteSupplierCandidate(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	deleteSupplierCandidate(input: $input) { id supplier { id name avatar } worker { id name firstName lastName middleName email phone avatar initials currency } email status token rate jobTitle links tags { id name } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
...
func (q *Querier) UpdateSupplierCandidate(ctx context.Context, vars map[string]any) (map[string]any, error) {
	...
	updateSupplierCandidate(input: $input) { id supplier { id name avatar } worker { id name firstName lastName middleName email phone avatar initials currency } email status token rate jobTitle links tags { id name } }
}`
	var result map[string]any
	err := q.Client.Execute(ctx, query, vars, &result)
	if err != nil {
