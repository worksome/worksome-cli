...
A multiplatform CLI for the [Worksome GraphQL API](https://docs.worksome.com/). Full API coverage via code generation from a vendored schema — <!-- resources -->83<!-- /resources --> resource groups, <!-- operations -->207<!-- /operations --> operations. Designed for both human users and AI agents.
...
- **Discovery is built in.** `worksome --help` lists all <!-- resources -->83<!-- /resources --> resource groups; `worksome <resource> --help` lists that resource's actions. All help text is generated from the GraphQL schema, so it cannot drift from the API.
...
internal/
  ...
  generated/        Generated code (committed, reviewed)
    commands/       Cobra commands (<!-- resources -->83<!-- /resources --> resource groups)
